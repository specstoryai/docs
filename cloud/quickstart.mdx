...
* **Cursor**: Install the SpecStory extension from Cursor’s marketplace. Chat with AI, then check `.specstory/history/` in your project.
* **VS Code + GitHub Copilot**: Install the SpecStory extension from VS Code Marketplace. Chat with Copilot, then check `.specstory/history/`.
...
<CardGroup>
  ...
  <Card title="Teams & Sharing" icon="users" href="/cloud/teams-and-sharing">
    See what’s shipping next for collaboration.
  </Card>
</CardGroup>
