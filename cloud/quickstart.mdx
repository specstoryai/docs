...
<Warning>
**Beta Release Required for Cloud Sync**

To sync with SpecStory Cloud, you must download and install our beta release versions:
- **CLI (macOS)**: [Installation steps](#claude-code)
- **CLI (Linux/WSL AMD64)**: [https://static.specstory.com/cloud-beta/0.10.0-beta1/linux-amd64/specstory](https://static.specstory.com/cloud-beta/0.10.0-beta1/linux-amd64/specstory)
- **VS Code/Cursor Extension**: [https://static.specstory.com/cloud-beta/specstory-vscode-0.19.0-beta1.vsix](https://static.specstory.com/cloud-beta/specstory-vscode-0.19.0-beta1.vsix)

Regular release versions do not support cloud sync yet.
</Warning>
...
<Note>
**Important:** Cloud sync requires the beta versions linked above. Standard release versions do not yet support cloud functionality.
</Note>

### Cursor / VS Code + GitHub Copilot

Install the SpecStory extension beta version for Cloud support.


[Download SpecStory Beta VSIX](https://static.specstory.com/cloud-beta/specstory-vscode-0.19.0-beta1.vsix)
...
Install the SpecStory CLI beta version and run Claude Code through it so sessions are captured locally.

Download the appropriate version for your OS:
- [Download BETA for macOS](https://static.specstory.com/cloud-beta/0.10.0-beta1/macOS/specstory)

```bash
chmod +x specstory
xattr -r -d com.apple.quarantine specstory
sudo mv specstory /usr/local/bin/
brew uninstall specstory # remove the non-Beta version
specstory version
```

- [Download BETA for Linux/WSL AMD64](https://static.specstory.com/cloud-beta/0.10.0-beta1/linux-amd64/specstory)
