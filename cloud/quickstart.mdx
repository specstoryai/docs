...
Install the SpecStory extension (VSIX build for Cloud beta).


[Download SpecStory VSIX](https://static.specstory.com/cloud-beta/specstory-vscode-0.19.0-beta1.vsix)
