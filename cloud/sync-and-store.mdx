...
1. **Local Capture:** Editors (Cursor, VS Code + Copilot, BearClaude) and the CLI (Claude Code, Cursor CLI, Codex CLI, Gemini CLI) write Markdown histories into `.specstory/history/`.
