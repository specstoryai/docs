...
In SpecStory [v0.7.0]() for the _optional_ and _experimental_ Cursor Rules feature, we use:
...
<Check>
Usage of these features _never_ transmits your prompts or code in assistant responses to SpecStory.
</Check>
...
- Shared content is anonymous in the sense that we do not require authentication to share. But it is _public_. 
