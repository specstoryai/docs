...
In SpecStory `v0.7.0` and later for the _optional_ and Derived Rules feature, we use:
...
<Check>
  BearClaude _never_ captures or transmits your actual conversations with Claude Code to SpecStory.
</Check>
