...
* **🧪 *EXPERIMENTAL***: Auto-magically derive Cursor [Project Rules](https://docs.cursor.com/context/rules-for-ai#project-rules-recommended) to reduce manual drudgery.
