...
<CardGroup cols={3}>
  ...
  <Card title="Cursor CLI" icon="cursor-arrow-rays" href="/integrations/cursor-cli">
    Mirror Cursor’s agent in your terminal and archive collaborative reasoning with SpecStory.
  </Card>
  <Card title="Codex CLI" icon="cpu-chip" href="/integrations/codex-cli">
...
# 2. Run your preferred agent through SpecStory
specstory run <claude|cursor|codex>

# 3. Optionally convert past sessions later
specstory sync <claude|cursor|codex>
```
