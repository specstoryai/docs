...
<Info>
  Need Linux or WSL binaries? Download them from the [SpecStory release page](https://github.com/specstoryai/getspecstory/releases), make them executable, and move them into your `PATH`.
</Info>
