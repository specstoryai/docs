...
Exports _all_ Claude Code sessions into `.specstory/history/*.md`.
...
Claude Code lets you **act via AI** in your terminal. SpecStory ensures you _understand why_ those actions happened. This combination delivers:
