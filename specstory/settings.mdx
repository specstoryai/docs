...
<Tabs>
  ...
  <Tab title="Claude Code + Cursor CLI">
    ...
    | `run`     | Run Claude Code or Cursor CLI with auto-save to to local markdown files, and to SpecStory Cloud if logged in | `specstory run claude`<br />`specstory run cursor`    |
