...
<Tabs>
  <Tab title="VSCode + Copilot" tab-id="vscode">
  ...
  <Tab title="Cursor" tab-id="cursor">
    1. Open Cursor.
  ...
  <Tab title="Manual VSIX Install" tab-id="vsix">
    <Tip>
...
<Tabs>
  <Tab title="Install with Homebrew" tab-id="homebrew">
    ```bash
    brew tap specstoryai/tap
    brew install specstory
    ```
    
    Once installed, run `specstory --version` to confirm.
  </Tab>
  <Tab title="Download Binary" tab-id="binary">
    1. Download the latest release for your platform:
       - [macOS (Apple Silicon)](https://github.com/specstoryai/getspecstory/releases/download/v0.0.2/SpecStoryCLI_Darwin_arm64.tar.gz)
       - [macOS (Intel)](https://github.com/specstoryai/getspecstory/releases/download/v0.0.2/SpecStoryCLI_Darwin_x86_64.tar.gz)
       - [Linux (ARM64)](https://github.com/specstoryai/getspecstory/releases/download/v0.0.2/SpecStoryCLI_Linux_arm64.tar.gz)
       - [Linux (x64)](https://github.com/specstoryai/getspecstory/releases/download/v0.0.2/SpecStoryCLI_Linux_x86_64.tar.gz)
    
    2. Extract and move to your PATH:
       ```bash
       tar -xzf SpecStoryCLI_*.tar.gz
