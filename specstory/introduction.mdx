...
<Note>
  The SpecStory Extension [(changelog)](https://marketplace.visualstudio.com/items/SpecStory.specstory-vscode/changelog) supports both [Cursor](https://www.cursor.com/) and [GitHub Copilot](https://github.com/features/copilot). For terminal agents like [Claude Code](https://claude.ai/code), Cursor CLI, and Codex CLI, we offer a CLI wrapper ([changelog](https://github.com/specstoryai/getspecstory/releases)) that captures your sessions.
</Note>
...
<Info>
  The SpecStory CLI auto-generates markdown files from your chat sessions with terminal agents (e.g. Claude Code, Cursor CLI, Codex CLI, etc.). It runs the terminal agent while saving your conversations to `.specstory/history/` in your project.
</Info>
...
<Tabs>
  ...
  <Tab title="Download Linux/WSL Binary">
    1. Download the latest release for your platform:
       - [Linux (ARM64)](https://github.com/specstoryai/getspecstory/releases/download/v0.14.0/SpecStoryCLI_Linux_arm64.zip)
       - [Linux (x86)](https://github.com/specstoryai/getspecstory/releases/download/v0.14.0/SpecStoryCLI_Linux_x86_64.zip) (Note: If you're running WSL, download this)
