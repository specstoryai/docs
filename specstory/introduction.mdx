...
<Tabs>
  ...
  <Tab title="Download Linux/WSL Binary">
    1. Download the latest release for your platform:
       - [Linux (ARM64)](https://github.com/specstoryai/getspecstory/releases/download/v0.17.0/SpecStoryCLI_Linux_arm64.zip)
       - [Linux (x86)](https://github.com/specstoryai/getspecstory/releases/download/v0.17.0/SpecStoryCLI_Linux_x86_64.zip) (Note: If you're running WSL, download this)
