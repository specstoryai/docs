...
<Info>
  The SpecStory CLI for is a wrapper that auto-generates markdown files from your chat sessions with terminal agents (e.g. Claude Code, Cursor CLI, Codex CLI, etc.). It runs the terminal agent while saving your conversations to `.specstory/history/` in your project.
</Info>
