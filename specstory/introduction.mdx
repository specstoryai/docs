...
### SpecStory CLI for Claude Code and Cursor CLI

<Info>
  The SpecStory CLI for Claude Code and Cursor CLI is a wrapper that auto-generates markdown files from your chat sessions. It runs the terminal agent while saving your conversations to `.specstory/history/` in your project.
</Info>
