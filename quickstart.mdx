...
* **Still stuck**? See **[Integrations](/integrations)** for storage paths and known issues, or open **[Support](/support)**.



## Next steps

* Learn the **core features**: [Auto-save, Share, Derived Rules](/features).
