...
SpecStory **automatically saves 🗄️** your composer and chat history in your project's `.specstory` folder. Never lose a single conversation!
...
- **✅ Auto-save is on by default** - but you can turn it off in the settings.
