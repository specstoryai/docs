...
Save your composer history and chat history from your active project to a local markdown file by opening the command palette (Cmd/Ctrl+Shift+P) and running `SpecStory: Save Composer and Chat History`.
