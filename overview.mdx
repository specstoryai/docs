...
- **Works where you already code:** Cursor, VS Code + Copilot, Claude Code, Cursor CLI and Codex CLI.
...
Git solved _what changed_ in code. SpecStory solves _why it changed_.